...
class carbon extends Entities implements iRest
{
    ...
    public static function Get(array &$return, string $primary = null, array $argv) : bool
    {
        ...
        $sql = 'SELECT ' .  $sql . ' FROM RootPrerogative.carbon';
    ...
    */
    ...
    {
        $sql = 'INSERT INTO RootPrerogative.carbon (entity_pk, entity_fk) VALUES ( UNHEX(:entity_pk), UNHEX(:entity_fk))';
    ...
    */
    public static function Put(array &$return, string $primary, array $argv) : bool
    {
        ...
        $sql = 'UPDATE RootPrerogative.carbon ';
    ...
    */
    ...
    {
        $sql = 'DELETE FROM RootPrerogative.carbon ';
