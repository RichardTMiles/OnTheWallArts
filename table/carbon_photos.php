...
class carbon_photos extends Entities implements iRest
{
    ...
    public static function Get(array &$return, string $primary = null, array $argv) : bool
    {
        ...
        $sql = 'SELECT ' .  $sql . ' FROM RootPrerogative.carbon_photos';
    ...
    */
    ...
    {
        $sql = 'INSERT INTO RootPrerogative.carbon_photos (parent_id, photo_id, user_id, photo_path, photo_description) VALUES ( UNHEX(:parent_id), UNHEX(:photo_id), UNHEX(:user_id), :photo_path, :photo_description)';
    ...
    */
    public static function Put(array &$return, string $primary, array $argv) : bool
    {
        ...
        $sql = 'UPDATE RootPrerogative.carbon_photos ';
