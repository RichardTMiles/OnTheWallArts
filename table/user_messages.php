...
class user_messages extends Entities implements iRest
{
    ...
    public static function Get(array &$return, string $primary = null, array $argv) : bool
    {
        ...
        $sql = 'SELECT ' .  $sql . ' FROM RootPrerogative.user_messages';
    ...
    */
    ...
    {
        $sql = 'INSERT INTO RootPrerogative.user_messages (message_id, to_user_id, message, message_read) VALUES ( UNHEX(:message_id), UNHEX(:to_user_id), :message, :message_read)';
    ...
    */
    public static function Put(array &$return, string $primary, array $argv) : bool
    {
        ...
        $sql = 'UPDATE RootPrerogative.user_messages ';
    ...
    */
    ...
    {
        $sql = 'DELETE FROM RootPrerogative.user_messages ';
