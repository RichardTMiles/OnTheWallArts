...
class carbon_users extends Entities implements iRest
{
    ...
    public static function Get(array &$return, string $primary = null, array $argv) : bool
    {
        ...
        $sql = 'SELECT ' .  $sql . ' FROM RootPrerogative.carbon_users';
    ...
    */
    ...
    {
        $sql = 'INSERT INTO RootPrerogative.carbon_users (user_id, user_type, user_sport, user_session_id, user_facebook_id, user_username, user_first_name, user_last_name, user_profile_pic, user_profile_uri, user_cover_photo, user_birthday, user_gender, user_about_me, user_rank, user_password, user_email, user_email_code, user_email_confirmed, user_generated_string, user_membership, user_deactivated, user_last_login, user_ip, user_education_history, user_location, user_creation_date, user_google_id, user_table_number, user_table_name) VALUES ( UNHEX(:user_id), :user_type, :user_sport, :user_session_id, :user_facebook_id, :user_username, :user_first_name, :user_last_name, :user_profile_pic, :user_profile_uri, :user_cover_photo, :user_birthday, :user_gender, :user_about_me, :user_rank, :user_password, :user_email, :user_email_code, :user_email_confirmed, :user_generated_string, :user_membership, :user_deactivated, :user_last_login, :user_ip, :user_education_history, :user_location, :user_creation_date, :user_google_id, :user_table_number, :user_table_name)';
        ...
        $json['sql'][] = $sql;
            ...
            $stmt->bindParam(':user_id',$user_id, 2, 16);
                ...
                $user_google_id = isset($argv['user_google_id']) ? $argv['user_google_id'] : null;
                $stmt->bindParam(':user_google_id',$user_google_id, 2, 30);
                    
                $user_table_number = isset($argv['user_table_number']) ? $argv['user_table_number'] : null;
                $stmt->bindParam(':user_table_number',$user_table_number, 2, 10);
                    
                $user_table_name = isset($argv['user_table_name']) ? $argv['user_table_name'] : null;
                $stmt->bindParam(':user_table_name',$user_table_name, 2, 200);
    ...
    */
    public static function Put(array &$return, string $primary, array $argv) : bool
    {
        ...
        $sql = 'UPDATE RootPrerogative.carbon_users ';
        ...
        if (!empty($argv['user_google_id'])) {
            $set .= 'user_google_id=:user_google_id,';
        }
        if (!empty($argv['user_table_number'])) {
            $set .= 'user_table_number=:user_table_number,';
        }
        if (!empty($argv['user_table_name'])) {
        ...
        if (!empty($argv['user_table_number'])) {
            $user_table_number = $argv['user_table_number'];
            $stmt->bindParam(':user_table_number',$user_table_number, 2, 10);
        }
        if (!empty($argv['user_table_name'])) {
            $user_table_name = $argv['user_table_name'];
            $stmt->bindParam(':user_table_name',$user_table_name, 2, 200);
        }
