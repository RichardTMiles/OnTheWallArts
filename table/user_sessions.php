...
class user_sessions extends Entities implements iRest
{
    const PRIMARY = [
    ...
    public static function Get(array &$return, string $primary = null, array $argv) : bool
    {
        ...
        $sql = 'SELECT ' .  $sql . ' FROM RootPrerogative.user_sessions';
    ...
    */
    ...
    {
        $sql = 'INSERT INTO RootPrerogative.user_sessions (user_id, time_in) VALUES ( UNHEX(:user_id), :time_in)';
        ...
        $json['sql'][] = $sql;
                ...
                $stmt->bindParam(':user_id',$user_id, 2, 16);
                    $stmt->bindValue(':time_in',isset($argv['time_in']) ? $argv['time_in'] : null, 2);
    ...
    */
    public static function Put(array &$return, string $primary, array $argv) : bool
    {
        ...
        $sql = 'UPDATE RootPrerogative.user_sessions ';
        ...
        if (!empty($argv['time_in'])) {
            $stmt->bindValue(':time_in',$argv['time_in'], 2);
        }
    ...
    */
    ...
    {
        $sql = 'DELETE FROM RootPrerogative.user_sessions ';
