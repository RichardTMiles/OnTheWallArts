...
class carbon_tag extends Entities implements iRest
{
    ...
    public static function Get(array &$return, string $primary = null, array $argv) : bool
    {
        ...
        $sql = 'SELECT ' .  $sql . ' FROM RootPrerogative.carbon_tag';
    ...
    */
    ...
    {
        $sql = 'INSERT INTO RootPrerogative.carbon_tag (entity_id, user_id, tag_id, creation_date) VALUES ( UNHEX(:entity_id), UNHEX(:user_id), :tag_id, :creation_date)';
    ...
    */
    public static function Put(array &$return, string $primary, array $argv) : bool
    {
        ...
        $sql = 'UPDATE RootPrerogative.carbon_tag ';
    ...
    */
    ...
    {
        $sql = 'DELETE FROM RootPrerogative.carbon_tag ';
