...
class carbon_reports extends Entities implements iRest
{
    ...
    public static function Get(array &$return, string $primary = null, array $argv) : bool
    {
        ...
        $sql = 'SELECT ' .  $sql . ' FROM RootPrerogative.carbon_reports';
    ...
    */
    ...
    {
        $sql = 'INSERT INTO RootPrerogative.carbon_reports (log_level, report, date, call_trace) VALUES ( :log_level, :report, :date, :call_trace)';
    ...
    */
    public static function Put(array &$return, string $primary, array $argv) : bool
    {
        ...
        $sql = 'UPDATE RootPrerogative.carbon_reports ';
    ...
    */
    ...
    {
        $sql = 'DELETE FROM RootPrerogative.carbon_reports ';
